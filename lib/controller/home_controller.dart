...
class HomeController extends GetxController{
  ...
  late CollectionReference popularProductCollection;
  ...
  void onInit() async {
    ...
    popularProductCollection = firestore.collection('popular');
  ...
  fetchProducts() async {
    try {
      QuerySnapshot productSnapshot = await popularProductCollection.get();
      final List<Product> retrievedProducts = productSnapshot.docs.map((doc) => Product.fromJson(doc.data() as Map<String, dynamic>)).toList();
      products.clear();
      products.assignAll(retrievedProducts);
      productShowInUi.assignAll(products);
